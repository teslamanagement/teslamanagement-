  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center flex flex-col items-center">
        {/* Primary Headline */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-neutral-900 font-sans leading-tight mb-4">
          Experience <span className="text-red-600">Tesla</span>
        </h1>

        {/* Subheadline */}
        <p className="text-base sm:text-lg md:text-xl text-neutral-600 font-normal max-w-2xl mb-8 leading-relaxed">
          Explore vehicle models, specifications, available promotional pricing, and dedicated client management assistance.
        </p>

        {/* Dual Call-to-Action Buttons */}
        <div className="flex flex-wrap items-center justify-center gap-3.5 w-auto mb-10">
          <button
            type="button"
            id="hero-explore-vehicles-btn"
            onClick={onExploreVehicles}
            className="px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-white font-bold text-sm sm:text-base tracking-wide transition-all duration-200 shadow-xs hover:shadow-md cursor-pointer flex items-center justify-center space-x-2 active:scale-95"
          >
